...
namespace DTE33
{
	...
	public class getVersionPatchCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		internal getVersionPatchCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
